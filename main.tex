...
\begin{subparts}
	...
	journal?
	\subpart\marginnote{$2$} Give two advantages of e-journals over the conventional print journals.	
	...
	\subpart\marginnote{$2$}What do you mean by open access repositories? Give example. 
\end{subparts}
\part\marginnote{$10$}  Answer the following questions.
\begin{subparts}
